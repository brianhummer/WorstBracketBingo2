...
using WorstBracketBingo.Models.AccountViewModels;
...
namespace WorstBracketBingo.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(UserManager<ApplicationUser> userManager, IOptions<IdentityOptions> identityOptions, IOptions<JwtOptions> jwtOptions,
            IEmailSender emailSender, SignInManager<ApplicationUser> signInManager, ILoggerFactory loggerFactory)
        {
